    ...
    <div className="mt-auto flex h-15 w-full flex-none items-center justify-between gap-2 border-t border-gray-200 bg-gray-100 p-2">
      <Dialog>
        <DialogTrigger asChild>
          <button className="flex h-10 w-full cursor-pointer items-center justify-center gap-2 rounded-md bg-transparent px-3 text-sm font-medium text-gray-600 transition-colors hover:bg-gray-200 hover:text-gray-900">
